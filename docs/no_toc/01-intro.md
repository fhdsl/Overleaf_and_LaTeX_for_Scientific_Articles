...
3) It makes it easy to collaborate with others.
4) There is lots of online support.
5) It's online and requires no installations.
6) It can sync with GitHub or Dropbox (if you pay for a paid plan).

## Overleaf makes it easier
