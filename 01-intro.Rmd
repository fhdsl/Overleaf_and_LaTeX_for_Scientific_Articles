...
The free version only allows you to have one collaborators on a project, so collaboration is more limited, however you can still benefit from many of the other features.  It is also important to note that students can receive a discount as well.

If possible it might be worth seeing if your insittute would be willing to get an organizational licence.
...
So how does Overleaf make it easier to write with LaTeX? We will go over some major ways, Overleaf can help, starting with an overview of some major features.
...
You can also view the document in a more WYSIWYG manner - called Rich Text.
...
If you are using the default view and you want to see what the file looks like in the rendered form in the location of the source text of the editor, you can click on the arrow in between.
