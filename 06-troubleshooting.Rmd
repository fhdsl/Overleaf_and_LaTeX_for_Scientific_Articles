...
Overleaf has lots of helpful information about:
    ...
    - [Learing LaTeX](https://www.overleaf.com/learn/latex/Learn_LaTeX_in_30_minutes)
...
1. Overleaf has a symbol palatte to help you write with symbols. This can be accessed by pressing the symbol button, which looks like an omega, at the top menu.
...
1. The log can give you more information about any errors or potential issues with your document. Each message in the log has a link to take you to the potentailly problematic line of code.
