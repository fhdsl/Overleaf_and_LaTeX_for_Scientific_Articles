...
# Figure and tables and citations, oh my!
...
You will notice that the template has a few examples of each of these elements that we will walk through these now. 
...
To add this new figure to your document you just need to modify the code above so that the name of the image file matches the name of the file you uploaded.
...
ottrpal::include_slide("https://docs.google.com/presentation/d/1UgGtVn7RsqdQ4pJxDk_dueSyREHcH-uWTNAT27E2mG8/edit#slide=id.g1c91f28435b_0_112")
```
...
First we need to get out of the tabular mode, and  we need our trusty `\end{}`function. In this case, we end with `\end{tabular}`. To end the table overall, we use `\end{table}`. We will discuss what the `\lab{}` function does soon.
