...
The `\maketitle` will add the title the page where the `begin{document}` command was used. Otherwise, if you used it before `begin{document}`, the title and authors will show up on a separate page. You can test it out to see how the document changes.
