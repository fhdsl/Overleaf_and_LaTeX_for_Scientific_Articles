...
The `\paragraph{}` command works similarly, but drops it will not be numbered. The text within the brackets is an optional word that will have bold font to start the paragraph. You can also leave it empty. 
